// ============================================================
//  JARVIS AI SERVER — Phase 5: Swing Analysis + Key Levels
        ...
        if (choice.message.tool_calls && choice.message.tool_calls.length > 0) {
            ...
            for (const tc of choice.message.tool_calls) {
                ...
                if (result.is_read_tool && toolData) {
                    ...
                    console.log(`[TOOL] ${toolName}(${tc.function.arguments}) -> ${result.success ? 'OK' : 'FAIL'}`);
...
app.listen(PORT, async () => {
    console.log('');
    console.log('========================================');
    console.log('  JARVIS AI SERVER — Phase 5');
    console.log('  Swing Analysis + Key Levels');
    console.log('========================================');
